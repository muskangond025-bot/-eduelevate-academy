...
export const NotFoundPage = () => {
  ...
  return (
    <div className="bg-[#F9FAFB] min-h-screen font-sans selection:bg-orange-500 selection:text-white pb-20">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          >
             ...
             <motion.div 
               ...
               className="absolute -top-4 -right-4 w-12 h-12 bg-[#F97316] rounded-xl flex items-center justify-center text-white font-black text-2xl shadow-lg shadow-orange-500/30"
             >
                ?
             </motion.div>
          </motion.div>
          ...
          <motion.h1 
            ...
            className="text-5xl md:text-7xl font-black text-[#1E3A8A] tracking-tighter mb-6"
          >
            Oops! You’ve taken a <span className="text-[#F97316] italic">wrong turn</span> 📚
          </motion.h1>
          ...
          >
            <Link to="/" className="w-full sm:w-auto px-8 py-4 bg-[#1E3A8A] text-white rounded-2xl font-bold flex items-center justify-center gap-2 hover:bg-slate-900 transition-all hover:scale-105 active:scale-95 shadow-xl shadow-blue-900/20">
              Go to Homepage
            </Link>
            <Link to="/courses" className="w-full sm:w-auto px-8 py-4 bg-white text-[#1E3A8A] border-2 border-slate-100 rounded-2xl font-bold flex items-center justify-center gap-2 hover:border-[#F97316] hover:text-[#F97316] transition-all hover:scale-105 active:scale-95">
              Explore Courses
            </Link>
          </motion.div>
      ...
      <section className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white p-8 md:p-16 rounded-[4rem] shadow-sm border border-slate-100 overflow-hidden relative">
          ...
          <div className="relative z-10 max-w-3xl">
            <h2 className="text-3xl font-black text-[#1E3A8A] mb-8">Let's find your <span className="text-[#F97316]">way back.</span></h2>
            ...
            <form onSubmit={handleSearch} className="relative mb-12">
               <input 
                 ...
                 className="w-full h-18 bg-slate-50 border border-slate-100 rounded-3xl px-8 pl-16 focus:outline-none focus:ring-4 focus:ring-orange-500/10 focus:border-[#F97316] transition-all font-medium"
               />
               <Search className="absolute left-6 top-1/2 -translate-y-1/2 text-slate-400" size={24} />
               <button type="submit" className="absolute right-3 top-1/2 -translate-y-1/2 bg-[#F97316] text-white px-6 py-3 rounded-2xl font-bold hover:bg-orange-600 transition-colors">
                  Search
               </button>
            </form>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              {quickLinks.map((link, i) => (
                ...
                >
                   ...
                   <div className="text-sm font-bold text-slate-600 group-hover:text-[#1E3A8A] transition-colors uppercase tracking-widest">{link.label}</div>
                </Link>
              ))}
            </div>
          </div>
      ...
      <section className="py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-6">
           {['I am in 10th', 'I am in 11th', 'I am in 12th'].map((path, i) => (
             <Link key={i} to="/path" className="px-10 py-6 bg-white border border-slate-100 rounded-full font-black text-[#1E3A8A] uppercase tracking-widest text-xs hover:border-[#F97316] hover:text-[#F97316] hover:shadow-2xl transition-all hover:-translate-y-1">
                {path}
             </Link>
           ))}
        </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
           <div className="flex justify-between items-end mb-12">
              <div>
                 <h2 className="text-4xl font-black text-[#1E3A8A] tracking-tighter uppercase italic">Most Chosen <br/><span className="text-[#F97316]">by Students.</span></h2>
              </div>
           ...
           <div className="flex gap-8 overflow-x-auto pb-10 scrollbar-hide snap-x">
             {popularCourses.map((course, i) => (
               ...
               >
                  <div className="w-14 h-14 bg-white rounded-2xl flex items-center justify-center text-[#F97316] mb-8 shadow-sm">
                     <BookOpen size={24} />
                  </div>
                  <h3 className="text-2xl font-black text-[#1E3A8A] mb-4 tracking-tight leading-tight">{course.title}</h3>
                  <p className="text-slate-500 font-medium mb-10 text-sm leading-relaxed">{course.desc}</p>
                  <Link to={course.to} className="inline-flex items-center gap-2 text-xs font-black text-[#1E3A8A] uppercase tracking-widest group-hover:text-[#F97316] transition-colors">
      ...
      <section className="py-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
           <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
              <div>
                 <h2 className="text-5xl font-black text-[#1E3A8A] tracking-tighter italic mb-8">Thousands of students found their path — <span className="text-[#F97316]">you can too.</span></h2>
                 ...
                 <Link to="/results" className="inline-flex items-center gap-3 text-sm font-black text-[#F97316] uppercase tracking-[0.2em] hover:gap-6 transition-all">
              ...
              <div className="grid grid-cols-2 gap-8">
                 <div className="p-10 bg-white border border-slate-100 rounded-[3rem] shadow-sm text-center">
                    ...
                    <div className="text-4xl font-black text-[#1E3A8A] mb-2 tracking-tighter italic">AIR 14</div>
                 ...
                 <div className="p-10 bg-white border border-slate-100 rounded-[3rem] shadow-sm text-center lg:translate-y-12">
                    ...
                    <div className="text-4xl font-black text-[#1E3A8A] mb-2 tracking-tighter italic">98%</div>
                 ...
                 <div className="p-10 bg-white border border-slate-100 rounded-[3rem] shadow-sm text-center">
                    ...
                    <div className="text-4xl font-black text-[#1E3A8A] mb-2 tracking-tighter italic">25k+</div>
                 ...
                 <div className="p-10 bg-white border border-slate-100 rounded-[3rem] shadow-sm text-center lg:translate-y-12">
                    ...
                    <div className="text-4xl font-black text-[#1E3A8A] mb-2 tracking-tighter italic">24/7</div>
      ...
      <section className="py-20">
         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="bg-[#1E3A8A] p-20 rounded-[4rem] text-white text-center shadow-3xl relative overflow-hidden group">
               ...
               <div className="relative z-10">
                  <h3 className="text-4xl md:text-5xl font-black italic tracking-tighter uppercase mb-6">Not sure <span className="text-[#F97316]">where to start?</span></h3>
                  ...
                  <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                    <Link to="/book-demo" className="w-full sm:w-auto px-10 py-5 bg-[#F97316] text-white rounded-3xl font-black uppercase tracking-widest text-xs hover:bg-orange-600 transition-all shadow-xl shadow-orange-500/20 hover:scale-105 active:scale-95">
      ...
      <section className="pt-20 text-center">
         <div className="max-w-4xl mx-auto px-4">
            <h4 className="text-2xl font-black text-[#1E3A8A] mb-4">Need guidance?</h4>
            <p className="text-slate-500 font-medium mb-8">Talk directly to our academic experts for personal counselling.</p>
            <Link to="/contact" className="inline-flex items-center gap-3 px-8 py-4 bg-white border-2 border-slate-100 text-[#1E3A8A] rounded-2xl font-bold hover:border-[#1E3A8A] transition-all group">
